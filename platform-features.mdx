...
description: Explore the advanced capabilities that enhance your workflow, including integrations and branding options.
---
...
<Columns cols={3}>
  <Card title="eSignatures" icon="edit-3" href="/docs/esignatures">
    Collect legally binding approvals with one-click workflows.
  </Card>
  <Card title="SDE Analysis" icon="bar-chart-3" href="/docs/sde-tools">
    Automate Seller's Discretionary Earnings calculations instantly.
  </Card>
  <Card title="CRM Integration" icon="users" href="/docs/crm">
...
<Steps>
  <Step title="Upload CIM" icon="upload">
    Share your generated CIM via custom URL.
  </Step>
  <Step title="Request Signature" icon="edit-3">
    Add signers and set expiration dates.
  </Step>
  <Step title="Track Status" icon="check-circle">
